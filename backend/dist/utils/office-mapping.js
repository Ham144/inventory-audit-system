...
export function mapLocationToOffice(locationCode) {
...
export async function mapLocationToOfficeAsync(locationCode) {
    const code = locationCode.trim().toUpperCase();
    if (code === "SEMUA" || !code)
        return locationCode;
...
export async function mapOfficeToLocation(officeName) {
